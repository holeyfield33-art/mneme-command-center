...
def get_runtime_status(
    ...
    return {
        ...
        "claude_configured": claude_command_configured,
        "claude_code_timeout_seconds": settings.claude_code_timeout_seconds,
        "claude_code_max_retries": settings.claude_code_max_retries,
        "claude_code_retry_delay_seconds": settings.claude_code_retry_delay_seconds,
        "claude_artifact_dir_configured": bool(settings.claude_artifact_dir.strip()),
        "claude_command_supports_prompt_placeholder": "{prompt_file}" in settings.claude_code_command,
